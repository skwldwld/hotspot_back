...
insert into silbi_portfolio_likelion.user_character(character_back_image, character_front_big_image, character_front_small_image, character_info, character_name, spicy_level, character_my_page_image, original_color, changed_color)
...
매운 음식을 먹을 때마다 코찔찔이 맹구가 되는 당신! 어쩌면 세상에서 매운 것을 가장 못 먹는 존재일 수 있습니다.','맵구',1,'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/47b3507a-67a5-49c7-8b35-f8e9b7b105cdKakaoTalk_20240521_211859997_01.png', 'A9C6AE', 'D8E5DA');
...
모든 힘이 힘에서 오는 것은 아니라는 겸손한 상기이다.','맵노스',2,'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/fd65325e-781d-4265-8b05-fbeaf80871a8KakaoTalk_20240521_211859997_02.png','FBE0B7', 'FDF1DE');
...
매운 음식을 잘 먹는다고 생각하는 당신은 주기적으로 매운 음식에 돈을 투자합니다. 매운 음식을 좋아하고, 자신감도 넘치지만, 사실 그렇게까지 잘 먹는 건 아닙니다. 그저 한국인의 평균적인 수준이죠 그래도 매운 음식에 대한 열정만큼은 누구에게도 뒤지지 않습니다.'
    ,'맵물주',3, 'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/8fea6cce-8bfe-4885-81e0-289e5a05d45bKakaoTalk_20240521_211859997_03.png','F4B6A7', 'FADED7');
