...
public class KakaoMapsApiController {
	...
	public Mono<ResultOfMaps> searchPlace(@RequestParam double x, @RequestParam double y, @RequestParam int radius) {
		String query = "음식점";
...
//		String category_group_code = "FD6";
//		int page = 1;
//		return kakaoMapService.saveStoreListInCache(query, category_group_code, x, y, radius, page);
//	}
